...
public class show_loss extends javax.swing.JFrame {

    
     Connection conn=null;
    ResultSet re=null;
    PreparedStatement str=null;
    new_adresss n = new new_adresss();
    int index ;
    public show_loss() {
        initComponents();
         setResizable(false);
        table_loss.setEnabled(false);
         index =1;
    }
    ...
    private void initComponents() {
        ...
        table_loss.setAlignmentX(5.0F);
        table_loss.setAlignmentY(5.0F);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_add, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     void search_mon()
     {
       ...
       conn = Java_connect.connect();
        ...
        String sql ="select data from loss_table where date like '"+date_re_s +"' ";
    ...
    void show_l()
    {
       ...
       String date_re =""+d+"-"+mo+"-"+y+"";
        ...
        String sql ="select data from loss_table where date =?";
            str = conn.prepareStatement(sql);
     ...
     void show_elagmaly()
    {
       ...
       String date_re =""+d+"-"+mo+"-"+y+"";
       conn = Java_connect.connect();
        String sql ="select sum(mony_less) from loss_table where date = ?";
            str = conn.prepareStatement(sql);
            ...
            if(re.next())
                    {
                       String sum = re.getString("sum(mony_less)");
                       jLabel7.setText(sum);
                    }
     ...
     void show_elagmaly_for_mon()
    {
       ...
       conn = Java_connect.connect();
        ...
        String sql ="select sum(mony_less) from loss_table where date like '"+date_re_s +"' ";
            str = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(show_loss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
